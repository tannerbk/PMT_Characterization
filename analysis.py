...
if __name__=='__main__':
    ...
    parser.add_argument('-s', '--source', type=str, default="Cherenkov")
    parser.add_argument('-c', '--magnetic-compensation', type=str, default="1layer")
    parser.add_argument('-p', '--pmt-type', type=str, default="R14688")
