...
const unsigned long number_entries = 80000; 
const unsigned long number_files = 2; 
const unsigned long number_windows = 4; 
const int high_voltage = 1344; 
const unsigned long window_start = 729;
const int length_late = 80; 
const float variance_cut = 0.00014; 
...
TString box_title = Form("11 Inch ET PMT: D784 KFLB, 105"); 
...
int main (int argc, char* argv[])
{
  ...
  try
      ...
      for(i = High_bin_counter; i < High_bin_counter + 1000; i++)
	{
      ...
      Double_t Peak_to_valley = spe_mean/min_function; 
